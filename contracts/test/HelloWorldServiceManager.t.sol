...
import {PayrollServiceManager} from "../src/PayrollServiceManager.sol";
...
import {IPayrollServiceManager} from "../src/IPayrollServiceManager.sol";
...
contract HelloWorldTaskManagerSetup is Test {
    ...
    // ) internal {
    //     IPayrollServiceManager helloWorldServiceManager = IPayrollServiceManager(
    //             helloWorldDeployment.helloWorldServiceManager
    //         );
    ...
    //     Operator memory operator,
    //     IPayrollServiceManager.Task memory task,
    ...
    //     IPayrollServiceManager(helloWorldDeployment.helloWorldServiceManager)
...
contract RegisterOperator is HelloWorldTaskManagerSetup {
    ...
    IPayrollServiceManager internal sm;
...
contract CreateTask is HelloWorldTaskManagerSetup {
    ...
    //     vm.prank(generator.key.addr);
    //     IPayrollServiceManager.Task memory newTask = sm.createNewTask(taskName);
    // }
}
...
contract RespondToTask is HelloWorldTaskManagerSetup {
    ...
    //     IPayrollServiceManager.Task memory newTask = sm.createNewTask(
    //         taskName
    //     );
